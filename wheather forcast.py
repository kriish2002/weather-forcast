...
def getWeather():
        ...
        name.config(text="CURRENT WEATHEER")

        #Weather
 
        api ="https://api.openweathermap.org/data/2.5/weather?lat="+city+"&a83159762394c30b6654e5948bde9c4c"
...
Frame_image=PhotoImage(file="boxx .png")
